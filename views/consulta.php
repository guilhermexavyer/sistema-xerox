...
<body>
    ...
    <main>
        ...
        <div class="container">
            <!-- EDUCAÇÃO INFANTIL -->
            <div>
                <form action="../select/educacao_infantil.php" method="POST">
            ...
            <div>
                <form action="../select/ensino_fundamental_1.php" method="POST">
        ...
        <div class="container">
            ...
            <div>
                <form action="../select/ensino_fundamental_2.php" method="POST">
            ...
            <!-- ENSINO MÉDIO -->
            <div>
                <form action="../select/ensino_medio.php" method="POST">
                    <h2>Ensino Médio</h2>
        ...
        <div>
            <form action="../select/funcionarios.php" method="POST">
                <h2>Funcionários</h2>
